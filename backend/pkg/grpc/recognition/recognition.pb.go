...
type ZoneConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Points        []*ZonePoint           `protobuf:"bytes,1,rep,name=points,proto3" json:"points,omitempty"`                                  // polygon vertices in relative coords [0..1]
	MinPlateRel   float64                `protobuf:"fixed64,2,opt,name=min_plate_rel,json=minPlateRel,proto3" json:"min_plate_rel,omitempty"` // min plate height as fraction of frame height [0..1]
	MaxPlateRel   float64                `protobuf:"fixed64,3,opt,name=max_plate_rel,json=maxPlateRel,proto3" json:"max_plate_rel,omitempty"` // max plate height as fraction of frame height [0..1]
	MaxTilt       int32                  `protobuf:"varint,4,opt,name=max_tilt,json=maxTilt,proto3" json:"max_tilt,omitempty"`                // max allowed plate tilt in degrees
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ZoneConfig) GetPoints() []*ZonePoint {
	if x != nil {
		return x.Points
	}
	return nil
...
func (x *ZoneConfig) GetMinPlateRel() float64 {
	if x != nil {
		return x.MinPlateRel
	}
	return 0
}

func (x *ZoneConfig) GetMaxPlateRel() float64 {
	if x != nil {
		return x.MaxPlateRel
	}
	return 0
}

func (x *ZoneConfig) GetMaxTilt() int32 {
	if x != nil {
		return x.MaxTilt
	}
	return 0
...
type StartWorkerRequest struct {
	...
	Stream        string                 `protobuf:"bytes,2,opt,name=stream,proto3" json:"stream,omitempty"`
	Zone          *ZoneConfig            `protobuf:"bytes,3,opt,name=zone,proto3" json:"zone,omitempty"` // optional: if absent, full frame is processed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StartWorkerRequest) GetZone() *ZoneConfig {
	if x != nil {
		return x.Zone
	}
	return nil
...
func (x *VideoPlateDetection) Reset() {
	*x = VideoPlateDetection{}
	mi := &file_recognition_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VideoPlateDetection) Descriptor() ([]byte, []int) {
	return file_recognition_proto_rawDescGZIP(), []int{24}
}
...
func (x *DetectionEvent) Reset() {
	*x = DetectionEvent{}
	mi := &file_recognition_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DetectionEvent) Descriptor() ([]byte, []int) {
	return file_recognition_proto_rawDescGZIP(), []int{25}
}
...
const file_recognition_proto_rawDesc = "" +
	...
	"\x01y\x18\x02 \x01(\x01R\x01y\"\x9f\x01\n" +
	"\n" +
	"ZoneConfig\x12.\n" +
	"\x06points\x18\x01 \x03(\v2\x16.recognition.ZonePointR\x06points\x12\"\n" +
	"\rmin_plate_rel\x18\x02 \x01(\x01R\vminPlateRel\x12\"\n" +
	"\rmax_plate_rel\x18\x03 \x01(\x01R\vmaxPlateRel\x12\x19\n" +
	"\bmax_tilt\x18\x04 \x01(\x05R\amaxTilt\"v\n" +
	"\x12StartWorkerRequest\x12\x1b\n" +
	"\tcamera_id\x18\x01 \x01(\tR\bcameraId\x12\x16\n" +
	"\x06stream\x18\x02 \x01(\tR\x06stream\x12+\n" +
	"\x04zone\x18\x03 \x01(\v2\x17.recognition.ZoneConfigR\x04zone\"_\n" +
...
var file_recognition_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_recognition_proto_goTypes = []any{
	...
	(*ZonePoint)(nil),                       // 14: recognition.ZonePoint
	(*ZoneConfig)(nil),                      // 15: recognition.ZoneConfig
	(*StartWorkerRequest)(nil),              // 16: recognition.StartWorkerRequest
	(*StartWorkerResponse)(nil),             // 17: recognition.StartWorkerResponse
	(*StopWorkerRequest)(nil),               // 18: recognition.StopWorkerRequest
	(*StopWorkerResponse)(nil),              // 19: recognition.StopWorkerResponse
	(*GetWorkerStatusRequest)(nil),          // 20: recognition.GetWorkerStatusRequest
	(*GetWorkerStatusResponse)(nil),         // 21: recognition.GetWorkerStatusResponse
	(*TestVideoRequest)(nil),                // 22: recognition.TestVideoRequest
	(*TestVideoResponse)(nil),               // 23: recognition.TestVideoResponse
	(*VideoPlateDetection)(nil),             // 24: recognition.VideoPlateDetection
	(*DetectionEvent)(nil),                  // 25: recognition.DetectionEvent
}
var file_recognition_proto_depIdxs = []int32{
	...
	14, // 2: recognition.ZoneConfig.points:type_name -> recognition.ZonePoint
	15, // 3: recognition.StartWorkerRequest.zone:type_name -> recognition.ZoneConfig
	24, // 4: recognition.TestVideoResponse.detections:type_name -> recognition.VideoPlateDetection
	7,  // 5: recognition.DetectionEvent.bounding_box:type_name -> recognition.BoundingBox
	0,  // 6: recognition.RecognitionService.HealthCheck:input_type -> recognition.Empty
	2,  // 7: recognition.RecognitionService.Ping:input_type -> recognition.PingRequest
	4,  // 8: recognition.RecognitionService.TestRecognize:input_type -> recognition.TestRecognizeRequest
	22, // 9: recognition.RecognitionService.TestRecognizeVideo:input_type -> recognition.TestVideoRequest
	8,  // 10: recognition.RecognitionService.RecognizeFromStream:input_type -> recognition.StreamRequest
	10, // 11: recognition.RecognitionService.StopStreamRecognition:input_type -> recognition.StopStreamRecognitionRequest
	12, // 12: recognition.RecognitionService.GetStreamRecognitionStatus:input_type -> recognition.StreamRecognitionStatusRequest
	16, // 13: recognition.RecognitionService.StartWorker:input_type -> recognition.StartWorkerRequest
	18, // 14: recognition.RecognitionService.StopWorker:input_type -> recognition.StopWorkerRequest
	20, // 15: recognition.RecognitionService.GetWorkerStatus:input_type -> recognition.GetWorkerStatusRequest
	1,  // 16: recognition.RecognitionService.HealthCheck:output_type -> recognition.HealthResponse
	3,  // 17: recognition.RecognitionService.Ping:output_type -> recognition.PingResponse
	5,  // 18: recognition.RecognitionService.TestRecognize:output_type -> recognition.TestRecognizeResponse
	23, // 19: recognition.RecognitionService.TestRecognizeVideo:output_type -> recognition.TestVideoResponse
	9,  // 20: recognition.RecognitionService.RecognizeFromStream:output_type -> recognition.RecognizeResponse
	11, // 21: recognition.RecognitionService.StopStreamRecognition:output_type -> recognition.StopStreamRecognitionResponse
	13, // 22: recognition.RecognitionService.GetStreamRecognitionStatus:output_type -> recognition.StreamRecognitionStatusResponse
	17, // 23: recognition.RecognitionService.StartWorker:output_type -> recognition.StartWorkerResponse
	19, // 24: recognition.RecognitionService.StopWorker:output_type -> recognition.StopWorkerResponse
	21, // 25: recognition.RecognitionService.GetWorkerStatus:output_type -> recognition.GetWorkerStatusResponse
